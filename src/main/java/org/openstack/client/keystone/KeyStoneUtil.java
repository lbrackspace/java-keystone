...
public class KeyStoneUtil {
    private static Log LOG = LogFactory.getLog(KeyStoneUtil.class);
	/**
	 *  The name of the properties file we're looking for
	 */
	private final static String file = "keystone.properties";
	...
	private static synchronized void loadPropertiesFromClasspath() throws IOException {
        ...
        InputStream inputStream = KeyStoneUtil.class.getClassLoader()
